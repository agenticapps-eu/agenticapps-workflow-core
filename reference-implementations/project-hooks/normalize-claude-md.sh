...
#
# Adopted verbatim from agenticapps-dashboard's copy (2026-07-26), which is the
# only one carrying the workflow-collapse fix. agents-task-viewer's 314-line
# variant is this file's PREDECESSOR plus a 26-line opt-out banner and contains
# no functional addition — see README.md "Reconciliation record", difference 5.
#
