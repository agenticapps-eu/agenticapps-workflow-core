...
- [ ] 8.4 Point the Claude installer at core rather than its vendored 1.0.0 copy, so core is the operational source of truth. **Still open** — publication was done by hand via `install-shared-artifact.sh`; the installer still names its own copy
