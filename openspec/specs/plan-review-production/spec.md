# plan-review-production Specification

## Purpose
Governs the plan-review producer: where its implementation is tracked, how it
is versioned and downgraded, how the implementing host identity is declared,
which vendor responses count as reviews, and how the `REVIEWS.md` it writes
stays self-contained and safe to read as untrusted input.
